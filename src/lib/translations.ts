export const translations = {
  en: {
    ...
    demoTitle: "Sample Scenario",
    demoDesc: "Load a short dataset to see the full flow instantly.",
    demoAction: "Load Demo Data",
    demoLoading: "Loading demo...",
    demoSeeded: "Demo data loaded.",
    demoSeededFallback: "Demo loaded in local mode.",
    demoExists: "Demo already present.",
  ...
  ko: {
    ...
    demoTitle: "샘플 시나리오",
    demoDesc: "짧은 데이터셋을 불러 즉시 전체 흐름을 확인하세요.",
    demoAction: "데모 데이터 불러오기",
    demoLoading: "데모 로딩 중...",
    demoSeeded: "데모 데이터가 로드되었습니다.",
    demoSeededFallback: "로컬 모드로 데모를 로드했습니다.",
    demoExists: "이미 데모 데이터가 있습니다.",
    demoFailed: "데모 데이터를 불러오지 못했습니다.",
